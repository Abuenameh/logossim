...
const PORTS = ['D', 'Clock', 'Clear', 'Q', 'Qbar'];
...
const PositionedPort = styled(Port)`
  ...
  ${props => `${props.side}: ${(props.icon ? 28 : 75) - 2}px;`}
`;
...
export const Wrapper = styled.div`
  ...
  width: ${props => (props.icon ? 28 : 75)}px;
...
export default DFlipFlopWidget;
